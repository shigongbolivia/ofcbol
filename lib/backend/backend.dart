...
Future<int> queryOfcRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      OfcRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<OfcRecord>> queryOfcRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      OfcRecord.collection,
      OfcRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<OfcRecord>> queryOfcRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ContactPersonRecords (as a Stream and as a Future).
Future<int> queryContactPersonRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ContactPersonRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ContactPersonRecord>> queryContactPersonRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ContactPersonRecord.collection,
      ContactPersonRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ContactPersonRecord>> queryContactPersonRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
