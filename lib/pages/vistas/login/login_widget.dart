...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.customerPasswordTextController ??= TextEditingController();
    _model.customerPasswordFocusNode ??= FocusNode();
                        ...
                        child: Column(
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: Image.asset(
                                'assets/images/OFC-BOL-IMAGOTIPO-VERTICAL-BLANCO.png',
                                width: 100.0,
                                height: 100.0,
                                fit: BoxFit.contain,
                              ),
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 8.0, 16.0, 0.0),
                                child: Text(
                                  'Bienvenido(a) al Catálogo de Organizaciones Forestales Comunitarias',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    final user =
                                      ...
                                      _model
                                          .customerPasswordTextController.text,
                                    );
                                    if (user == null) {
                                      return;
                                    }
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.customerPasswordTextController,
                                focusNode: _model.customerPasswordFocusNode,
                                obscureText: !_model.customerPasswordVisibility,
                                decoration: InputDecoration(
