                          ...
                          child: Padding(
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  if (FFAppState().favoriteOfcs.length < 0)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 200.0, 0.0, 200.0),
                                      child: Text(
                                        'No tienes OFC\'s favoritas.',
                                                                            ...
                                                                            children: [
                                                                              FlutterFlowIconButton(
                                                                                ...
                                                                                icon: FaIcon(
                                                                                  ...
                                                                                  color: FFAppState().favoriteOfcs.contains(verticalListOfcRecord.reference) ? FlutterFlowTheme.of(context).primary : Color(0x56FCDC0C),
                                                                                  size: 24.0,
                                                                                ),
                                                                                onPressed: () async {
                                                                                  await showDialog(
                                                                                    ...
                                                                                    builder: (alertDialogContext) {
                                                                                      return AlertDialog(
                                                                                        title: Text(FFAppState().favoriteOfcs.length.toString()),
                                                                                        content: Text(FFAppState().favoriteOfcs.contains(verticalListOfcRecord.reference).toString()),
                                                                                        actions: [
                                                                                          TextButton(
