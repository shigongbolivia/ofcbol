...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFDFB600);
  late Color secondary = const Color(0xFF028133);
  late Color tertiary = const Color(0xFF52A254);
  late Color alternate = const Color(0xFF4D5334);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFFDCE6EB);
  late Color primaryBackground = const Color(0x878DB88E);
